...
//                                 width: width * 0.45,
//                                 child: Text(
//                                   'Access to any ${data[index]['no_of_workbook_in_alpha']}(${data[index]['no_of_workbook']}) E-engineering interactive Workbook',
//                                   style: TextStyle(
//                                       fontFamily: "Work Sans",
//                                       fontSize: 11,
//                                       color: Colors.black,
                        ...
                        GestureDetector(
                          onTap: () {
                            if (data[index]['name'] == "diamond package") {
                              context.push('/all_design',
                                  extra: {'planFilter': 'diamond'});
                            } else if (data[index]['name'] == "gold package") {
                              context.push('/all_design',
                                  extra: {'planFilter': 'gold'});
                            } else if (data[index]['name'] ==
                                "platinum package") {
